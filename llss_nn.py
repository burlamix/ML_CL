...
dataset.init_test(preproc.load_data(path=test_data_path, target=True, header_l=0))
...
_, _, normeqs_loss = normeqs_solve(biasedX, dataset.train[1])
_, _, qr_loss = QR_solve(biasedX, dataset.train[1])
